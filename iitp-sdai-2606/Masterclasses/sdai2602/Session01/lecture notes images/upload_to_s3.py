"""Upload sdai2602 masterclass session01 lecture note images to S3."""
import os
...
PREFIX = "iitp-sdai-2606/masterclasses/sdai2602/session01"
...
urls = {}
for path in sorted(images_dir.glob("masterclass-sdai2602-session01-*.png")):
