"""Upload session03 lecture note images to S3 and refresh links in Lecture Notes.md."""
import os
import re
...
PREFIX = "iitp-sdai-2606/module1/session03"
...
urls = {}
for path in sorted(images_dir.glob("session03-*.png")):
